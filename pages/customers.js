...
export default function Customers() {
  ...
  const [searchField, setSearchField] = useState('name') // 'name' | 'phone' | 'address' | 'aadhaar'
  ...
  const filteredCustomers = customers.filter(c => {
    ...
    switch (searchField) {
      ...
      case 'aadhaar':
        return (c.aadhaar_number || '').includes(searchTerm)
      case 'name':
      default:
        return c.customer_name.toLowerCase().includes(term)
    }
  })
